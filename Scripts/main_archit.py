...
def start(cmd):
    if "find meaning" in cmd or ("tell" in cmd and "meaning" in cmd) or ("find" in cmd and "meaning" in cmd):
        ...
        the_voice.say_and_print("In how many seconds you want to be reminded? Say the number")
        while True:
            ...
            try:
                ...
                if temp.lower() == "cancel":
                    return 1
                the_voice.say_and_print("Sorry! Just say the number, or say \"CANCEL\" to cancel")
